...
function TextApp() {
    ...
    async function handleSend(e) {
        ...
        if (input) {
            ...
            const resp = await fetch("https://cs571-hw11-server.netlify.app/.netlify/functions/completions", {
                method: "POST",
                headers: {
    ...
    /**
     * Called whenever the "Send" button is pressed (streaming).
     */
    async function handleSendAsStream(e) {
        ...
        if (input) {
            ...
            const resp = await fetch("https://cs571-hw11-server.netlify.app/.netlify/edge-functions/completions-stream", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "x-api-key": "AIzaSyAUOThRHi_rKG6naSLSBFHxhTQ_xlh5Tsc"
                },
                body: JSON.stringify(newMessages)
            });
