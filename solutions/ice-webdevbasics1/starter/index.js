...
function updateYield() {
    ...
    const rows = document
        .getElementById("ingredients table")
        .getElementsByTagName("tbody")[0] //Even with only one <tbody>，getElementsByTagName still returns a HTMLCollection
        .getElementsByTagName("tr");

    // For every row, calculate the amount needed. 
